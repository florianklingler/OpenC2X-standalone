...
static asn_per_constraints_t asn_PER_type_HighFrequencyContainer_constr_1 = {
...
static asn_TYPE_tag2member_t asn_MAP_HighFrequencyContainer_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* basicVehicleContainerHighFrequency at 42 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* rsuContainerHighFrequency at 43 */
};
